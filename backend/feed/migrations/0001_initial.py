    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sectionPic', models.ImageField(upload_to='images/postFile')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('postFile', models.FileField(null=True, upload_to='images/postFile')),
                ('postText', models.TextField(null=True)),
                ('likeCount', models.IntegerField(default=0)),
                ('commentCount', models.IntegerField(default=0)),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('postSection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='feed.section')),
